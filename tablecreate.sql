...
INSERT INTO problem_words(sentence, origin, pred_same, pred_corr) VALUES ("настольнцй ночник", "настольнцй", "настольный", "настольный");
INSERT INTO problem_words(sentence, origin, pred_same, pred_corr) VALUES ("она няша", "няша", "каша", "наша");
